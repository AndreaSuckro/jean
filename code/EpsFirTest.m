...
%clear workspace and assign variables
clc;
close all;
clear variables;
...
fprintf('Run Epsilon First Algorithms %d times with %d assignments',runs,assignments);
%% Calculation
...
parfor n = 1:runs
    ...
    % calculate epsilonfirst with different values for epsilon
